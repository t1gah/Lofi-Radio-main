...
const KazagumoTrack_1 = require("./KazagumoTrack");
...
class KazagumoQueue extends Array {
     ...
     */
    add(track) {
        if (Array.isArray(track) && track.some((t) => !(t instanceof KazagumoTrack_1.KazagumoTrack)))
            throw new Interfaces_1.KazagumoError(1, 'Track must be an instance of KazagumoTrack');
        if (!Array.isArray(track) && !(track instanceof KazagumoTrack_1.KazagumoTrack))
            track = [track];
        if (!this.current) {
