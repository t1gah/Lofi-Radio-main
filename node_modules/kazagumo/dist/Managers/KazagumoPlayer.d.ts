...
export declare class KazagumoPlayer {
     ...
     * @returns KazagumoPlayer
     */
    setTextChannel(textId: Snowflake): KazagumoPlayer;
    /**
     * Set voice channel and move the player to the voice channel
     * @param voiceId Voice channel ID
     * @returns KazagumoPlayer
     */
    setVoiceChannel(voiceId: Snowflake): KazagumoPlayer;
    /**
     * Set loop mode
     ...
     *
     */
    seek(position: number): KazagumoPlayer;
    /**
     * Set the volume
     * @param volume Volume
     * @returns KazagumoPlayer
